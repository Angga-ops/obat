...
<style>
  ...
  .menu_active{background:#ff9933;color:#fff;}
  .submenu_active{background:#ff9933;color:#fff;}
  .active{background:#ff9933;color:#fff;}
</style>
<div id="navbar" class="panel panel-success collapse navbar-collapse" style="padding:0px;">
  ...
  <div class="panel-body">
    ...
    <?php if ($level=='admin' || $level=='apotik'): ?>
      ...
      <li<?php if($menu=='stok'){echo ' class="submenu_active"';}?>>
        <a href="users?menu=stok"><i class="fa fa-tasks"></i> Stok Obat </a>
      </li>
      <li<?php if($menu=='transaksi'){echo ' class="submenu_active"';}?>>
    ...
    <?php if ($level=='admin'): ?>
      <li id="dropdown">
        ...
        <li<?php if($menu=='user'){echo ' class="submenu_active"';}?>>
          <a href="users?menu=user"><i class="fa fa-users"></i> User</a>
        </li>
      <?php endif; ?>
      <li><hr style="margin:0px;"> </li>
      <li<?php if($menu=='profile'){echo ' class="submenu_active"';}?>>
        <a href="users?menu=profile"><i class="fa fa-user"></i> Profile</a>
      </li>
      <li<?php if($menu=='ubah_pass'){echo ' class="submenu_active"';}?>>
